                        ...
                        ?>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <form method="post">
                                        <h6 class="m-0 font-weight-bold text-primary">TEAM REGISTRATION
                                            <button type="submit" name="btn1" class="<?php if ($events['prereg_approve'] == 1) {
                                                                                            echo "btn btn-success";
                                                                                        } else {
                                                                                            echo "btn btn-danger";
                                                                                        } ?> btn-user btn-block" style="width:100px; float: right; "><?php if ($events['prereg_approve'] == 1) {
                                                                                                                                                            echo "ON";
                                                                                                                                                        } else {
                                                                                                                                                            echo "OFF";
                                                                                                                                                        } ?></button>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="width:250px;">
                                                                <a class="btn btn-sm btn-success" href="process.php?events=<?php echo $eventid . '&id=' . $fetch_reg['id'] . '&status=1'; ?>">ACCEPT</a>
                                                                <a class="btn btn-sm btn-danger" href="process.php?events=<?php echo $eventid . '&id=' . $fetch_reg['id'] . '&status=2'; ?>">REJECT</a>

                                                                <a class="btn btn-sm btn-danger" href="deletereg.php?events=<?php echo $eventid . '&id=' . $fetch_reg['id']; ?>">Delete</a>
                                ...
                                <div class="card-header py-3">
                                    ...
                                    <form method="post">
                                        <h6 class="m-0 font-weight-bold text-primary">File Upload
                                            <button type="submit" name="btn2" class="<?php if ($events['upload_approve'] == 1) {
                                                                                            echo "btn btn-success";
                                                                                        } else {
                                                                                            echo "btn btn-danger";
                                                                                        } ?> btn-user btn-block" style="width:100px; float: right; "><?php if ($events['upload_approve'] == 1) {
                                                                                                                                                            echo "ON";
                                                                                                                                                        } else {
                                                                                                                                                            echo "OFF";
                                                                                                                                                        } ?></button>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $fetch_reg1['status']; ?></td>
                                                            <td>
                        ...
                        ?>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <form method="post">
                                        <h6 class="m-0 font-weight-bold text-primary">PARTICIPANTS REGISTRATION
                                            <button type="submit" name="btn3" class="<?php if ($events['team_approve'] == 1) {
                                                                                            echo "btn btn-success";
                                                                                        } else {
                                                                                            echo "btn btn-danger";
                                                                                        } ?> btn-user btn-block" style="width:100px; float: right; "><?php if ($events['team_approve'] == 1) {
                                                                                                                                                            echo "ON";
                                                                                                                                                        } else {
                                                                                                                                                            echo "OFF";
                                                                                                                                                        } ?></button>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $fetch_lotid2['lotno']; ?></td>
                                                            <td><?php echo $fetch_team2['name']; ?></td>
                                                            <td><?php echo $fetch_reg2['dno']; ?></td>
                                                            <td><?php echo $fetch_reg2['name']; ?></td>
                                                            <td><?php echo $fetch_reg2['class']; ?></td>
                                                            <td>
                                                                <a class="btn btn-sm btn-danger" href="deleteparticipants.php?events=<?php echo $eventid . '&id=' . $fetch_reg2['id']; ?>">Delete</a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
