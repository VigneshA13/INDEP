                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <?php
                                    $select2 = mysqli_query($con, "SELECT * FROM team WHERE id = " . $_GET['id']);
                                    $fetch2 = mysqli_fetch_array($select2);
                                    echo  strtoupper($dno) . " (" . $fetch2['name'] . ")";
                                    ?>
                                    <a href="./count.php" class="btn btn-primary btn-icon-split" style="float:right; margin-left:50px;">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $date = mysqli_query($con, " SELECT * FROM participants WHERE dno = '$dno'");
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            $select = mysqli_query($con, "SELECT * FROM events WHERE id = " . $Data['eventid']);
