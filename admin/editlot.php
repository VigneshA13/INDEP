...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        for ($i = 1; $i <= 26; $i++) {
            if (${'lot' . $i} != 0 || ${'lot' . $i} != null) {
                $sql1 = mysqli_query($con, "update lot set lotno='${'lot' .$i}' where teamid='${'team' .$i}' and eventid='$eventid'");
            }
        }
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">EDIT LOT - <?php echo $events['name']; ?>
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($room) > 0) {
                                                    while ($fetch_room = mysqli_fetch_array($room)) {
                                                        $teamno = $fetch_room["id"];
                                                        $lotdata = mysqli_query($con, " SELECT * FROM lot where teamid='$teamno' and eventid='$eventid' ");
                                                        $fetch_lotdata = mysqli_fetch_array($lotdata);
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" name="<?php echo 'lotno' . $fetch_room['id']; ?>" value="<?php echo $fetch_lotdata['lotno']; ?>" class="form-control" style="width:250px;" value="0"></td>
                                                ...
                                                <tr>
                                                    <td colspan=3 style="text-align:center;">
                                                        <input type="submit" name="submit" class="btn btn-primary" style="width:120px;" value="Update Lots">
                                                    </td>
