                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">EVENT PERMISSIOM DETAILS</h1>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">EVENT PERMISSIOM DETAILS
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="editPermission.php?id=<?php echo $fetch_lot['id']; ?>" class="btn btn-sm btn-primary" style="float:right;">
