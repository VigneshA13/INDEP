                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $date = mysqli_query($con, " SELECT * FROM question");
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo strtoupper($Data['dno']); ?></td>
                                                        <td>
                                                            <?php echo strtoupper($Data['name']); ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            $class = mysqli_query($con, "SELECT * FROM classes WHERE id = " . $Data['teamid']);
                                                            $fetch = mysqli_fetch_assoc($class);

                                                            echo strtoupper($fetch['class']);
                                                            ?>
                                                        </td>
                                                        <td><?php echo $Data['questions']  ?></td>
                                                        <td>
                                                            <a href="./deleteQuestions.php?id=<?= $Data['id']; ?>" class="btn btn-sm btn-danger ml-2">
