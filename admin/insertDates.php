...
if (isset($_POST['insertSubmit'])) {
    ...
    if (mysqli_query($con, "INSERT INTO registration (album, file,  upload_date ) VALUES ('$album', '$message', '$date')")) {
                                    ...
                                    <form method="post">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="date" name="date" class="form-control" style="width:100%;" placeholder="date" required>
                                                </td>
                                            </tr>
                                            <tr>
