                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><?php echo $stage == 0 ? "OFF STAGE EVENTS LOTS" : "ON STAGE EVENTS LOTS" ?></h6>
                                </div>
                                <div class="card-body">
                                            ...
                                            <table class="table table-borderless text-start align-middle mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th style="color: black;">Lot Number</th>
                                                    </tr>
                                                    <?php
                                                    if ($stage == 0) {
                                                        $i = 0;
                                                        $select1 = mysqli_query($con, "SELECT * FROM lot WHERE eventid <= 10 AND teamid = " . $_SESSION['id']);
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td style="width:40%; font-weight:bolder;" class="text-primary">
                                                                    <?php echo eventName($con, $data1['eventid']); ?>
                                                                </td>
                                                                <td style="color: black; font-weight:bolder; font-size: 18px;">
                                                                    <?php
                                                                    if ($data1['lotno'] <= 0) {
                                                                        echo "Non-Participating";
                                                                    } else {
                                                                        echo $data1['lotno'];
                                                                    }
                                                                    ?>
                                                    ...
                                                    if ($stage == 1) {
                                                        $i2 = 0;
                                                        $select2 = mysqli_query($con, "SELECT * FROM lot WHERE eventid > 10 AND teamid = " . $_SESSION['id']);
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td style="width:40%; font-weight:bolder;" class="text-primary">
                                                                    <?php echo eventName($con, $data2['eventid']); ?>
                                                                </td>
                                                                <td style="color: black; font-weight:bolder; font-size: 18px;">
                                                                    <?php
                                                                    if ($data2['lotno'] <= 0) {
