        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class="h5 mb-0 text-800 text-primary" style="font-weight: 700;">
                            <?php echo $reg == 0 ? "OFF STAGE EVENTS PARTICIPANTS LIST" : "ON STAGE EVENTS PARTICIPANTS LIST" ?></h5>
                    </div>
                    <?php
                    $id = $_SESSION['id'];
                    $sql = "SELECT eventid FROM participants WHERE teamid=$id group by eventid";
                    $result = $con->query($sql);
                    while ($row = $result->fetch_assoc()) {
                        $eid = $row['eventid'];
                        if ($reg == 0) {
                            $view = "SELECT * FROM participants WHERE eventid=$eid and teamid=$id and eventid<=10";
                            $result1 = $con->query($view);
                        } elseif ($reg == 1) {
                            $view = "SELECT * FROM participants WHERE eventid=$eid and teamid=$id and eventid>10";
                            $result1 = $con->query($view);
                        }
                        ...
                        $event = "SELECT * FROM events WHERE id=$eid";
                        $result2 = $con->query($event);
                        if ($no != 0) {
                    ?>
