                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless text-start align-middle mb-0">
                                                <tbody>
                                                    ...
                                                    $i = 0;
                                                    $select1 = mysqli_query($con, "SELECT * FROM question WHERE teamid = " . $_SESSION['id']);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:100%; font-weight:bolder;" class="text-primary">
                                                            <?= strtoupper($data1['dno'])  ?>
                                                        </td>
